...
// node_modules/genlayer-js/dist/chunk-M7SA3INM.js
var Address = class {
  constructor(addr) {
...
function accountActions(client) {
  return {
    fundAccount: async ({ address, amount }) => {
      var _a;
      if (((_a = client.chain) == null ? void 0 : _a.id) !== simulator.id) {
...
var overrideContractActions = (client) => {
  client.readContract = async (args) => {
    ...
    let senderAddress = (account == null ? void 0 : account.address) ?? ((_a = client.account) == null ? void 0 : _a.address);
    const requestParams = {
      to: address,
      from: senderAddress,
      data: encodedData
  ...
  client.writeContract = async (args) => {
    ...
    if ((senderAccount == null ? void 0 : senderAccount.type) !== "local") {
      const transaction = {
        from: senderAccount == null ? void 0 : senderAccount.address,
        to: address,
        data: serializedData,
